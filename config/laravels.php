...
return [
    ...
    'web_socket_listen_port'   => env('LARAVELS_LISTEN_PORT', 9502),
    ...
    'swoole'                   => [
         ...
         */
        'ssl_cert_file' => app_path('../ssl/live.zhangqingxi.cn.pem'),
        'ssl_key_file' => app_path('../ssl/live.zhangqingxi.cn.key'),
    ],
];
